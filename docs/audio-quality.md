...
The public `8-dmc_rates` ROM and all six APU frame-counter ROMs now pass; with the PPU/NMI and frame-counter timing changes, the full public suite passes 52/55. All previously passing ROMs remain passing. The complete results, including failures, are in [accuracy-results.md](accuracy-results.md).
